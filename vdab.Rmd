...
> Sommige onderdelen van de tekst en de figuren kunnen wegvallen. Gelieve de online versie te raadplegen voor betere kwaliteit.
...
_De cijfers tussen haakjes geven telkens het aantal resultaten per beroepscategorie weer_
...
Het resultaat kan niet rechtstreeks in dit PDF document getoond worden omdat het om een interactief krachtnetwerk gaat dat enkel in HTML goed weergegeven kan worden (zie interactieve versie [hier](https://github.com/ddhaese/Project_AI_Jobs)).
